% this RHC function optimizes the control for a range of turn rates
% calculates the RHC control value for a set mission duration 

function [rhc]=RHC_opt(omega_dot,tspan,x0,y0,theta0,p_exit,boundaryx,boundaryy,covered_area_x,covered_area_y,xc,yc,vel,epsilon,miss_duration)
Velocity=vel;
W=omega_dot;
p=p_exit;
...
condition=miss_duration-(tspan(end)+Time_exit);
...
%area not covered
%dtermines how to redirect the vehicle during the mission
