...
a1=plot(boundaryx,boundaryy,'b','Linewidth',5);
hold on 
...
while top_level_E>0  %ceil(Time_sec/dt)
    ...
    for count=1:ct
        ...
        a2=plot(calc_path(:,1),calc_path(:,2),'r','Linewidth',5);
        calc_path(1,:)=[];
...
a3=plot(top_PATH(:,1),top_PATH(:,2),'k','Linewidth',5);
a4=plot(top_level_footprint_x,top_level_footprint_y,'g','Linewidth',5);
...
legend([a1;a2;a3;a4],'bounded region','planned path', 'actual path','area covered')
